...
The first is a list of sites not caught by lists I subscribe to below  
The second is a combination list of all the lists below that has been deduplicated  
